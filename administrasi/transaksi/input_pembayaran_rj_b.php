...
$koneksi->query("INSERT INTO pembayaran(id_rj,nama,pengguna,obat,jml_obat,harga,tindakan,tarif,tanggal_bayar,total,status) VALUES('$id_rj','$nama','$pengguna','$obat','$jml_obat','$harga','$tindakan','$tarif','$tanggal_bayar','$total','Pembayaran Ditanggung BPJS')");
