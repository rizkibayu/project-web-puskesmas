...
$koneksi->query("INSERT INTO pembayaraninap(id_ri,nama,pengguna,obat,jml_obat,harga,tindakan,tarif,tanggal_bayar,nama_kamar,jml_kasur,harga_kamar,total,status) VALUES('$id_ri','$nama','$pengguna','$obat','$jml_obat','$harga','$tindakan','$tarif','$tanggal_bayar','$nama_kamar','$jml_kasur','$harga_kamar','$total','Pembayaran Inap Ditanggung BPJS')");
