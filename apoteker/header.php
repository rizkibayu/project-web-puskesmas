...
<head>
    ...
    <title> Puskesmas | Apoteker </title>
            ...
            <ul class="list-unstyled components">
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pagemenu">
                     ...
                     <ul class="collapse list-unstyled" id="pagemenu">
                        <li>
                            <a href="menu.php?halaman=tambah_obat">Tambah Obat</a>
                        </li>
                    </ul>
                  </li>
                   <li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <button type="button" id="sidebarCollapse" class="btn btn-info">
                        ...
                        <span><strong>Menu</strong></h2></span>
                    </button>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="../keluar.php"><strong>Keluar</strong></a>
                            </li>
                        </ul>
                        </ul>
                    </div>
