...
$koneksi->query("UPDATE obat SET nama_obat = '$nama_obat', stok_obat = '$stok_obat', type = '$type', harga = '$harga', keterangan = '$keterangan', kadaluarsa = '$kadaluarsa' WHERE id_obat = '$_GET[id]'");
